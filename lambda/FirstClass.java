...
public class FirstClass {
    ...
    public static void main(String[] args) {
        ...
        Instead of creating an interface which has only one abstract method and this method is being defined in
        a concrete class, we can essentially write the code of the function in the form of lambda.
         ...
         * }
         * applies before function to the input of before and then applies the function to the result of before.
         *
